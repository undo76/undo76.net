...
export default function Home() {
  return (
    <div className="min-h-screen bg-cool-gray-50 text-cool-gray-700 text-">
      <Navigation />
    ...
    <>
      <section className="flex flex-col md:flex-row overflow-hidden bg-red-300 shadow-lg flex-1 rounded-lg">
        ...
        <div className="bg-white p-4 flex-1">
          ...
          <h2 className="mt-2 text-lg text-red-900 uppercase">Main features</h2>
          <p>
            For more information about Tailwind's responsive design features,
...
function Button({ className = "bg-gray-300 text-gray-600", children }) {
  return (
    <button
      className={cx(
