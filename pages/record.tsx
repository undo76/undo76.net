        ...
        <Layout>
            <article className="prose m-auto">
                <div className="page-body">
                    ...
                    <p id="d36cd95d-102f-4103-846c-b30d4b6be882" className="">
                    ...
                    <p id="b061ba45-18a3-4051-8d2a-296842c30b29" className="">
                    ...
                    <h3 id="3ae70922-5c9d-41f3-a810-c45ca9ca567a" className="">
                        Programming
                    </h3>
                    <ul
                        id="60e2cbf4-691d-46b9-93d7-13480a3dfe6f"
                    ...
                    <ul
                        id="9f89553f-659c-4fdd-b32e-651416f34af1"
                        className="bulleted-list"
                    >
                        <li>
                            <strong>Languages:</strong> Java, Kotlin,
                            Javascript, Typescript, Python, C/C++11, Ruby.
                            Mostly forgotten: R, Rust, Haskell, ReasonML/Ocaml,
                            Prolog, Lisp, etc.
                        </li>
                    </ul>
                    <ul
                        id="884c8fed-0a09-4e3a-8d4d-90c604be4a58"
                        className="bulleted-list"
                    >
                        <li>
                    ...
                    <ul
                        id="23a0fc21-e1aa-4419-b649-8e1b292c94b9"
                        className="bulleted-list"
                    >
                        <li>
                    ...
                    <ul
                        id="e7fa05d3-dcf3-4945-aec5-fad62acce605"
                        className="bulleted-list"
                    >
                        <li>
                    ...
                    <ul
                        id="83266009-8139-4649-826e-4bbbb02c578b"
                        className="bulleted-list"
                    >
                        <li>
                    ...
                    <ul
                        id="8d67b35b-ba6e-43a5-87bb-62b39db7f103"
                        className="bulleted-list"
                    >
                        <li>
                    ...
                    <h3 id="1bc81148-fecf-4939-9aa6-fffce0378ffa" className="">
                        Architecture and Software development process
                    </h3>
                    <ul
                        id="9124e002-f369-48b0-b6cc-e2abad6be63c"
                        className="bulleted-list"
                    >
                        <li>
                    ...
                    <ul
                        id="c5b7aae2-b99f-46b9-8a9f-3f3b9b6b227c"
                        className="bulleted-list"
                    >
                        <li>
                            <strong>Architecture:</strong> Domain Driven Design,
                            Layered arquitecture, Hexagonal/clean architecture,
                            Microservices, Event Sourcing, CQRS, Dependency
                            Injection, Test Driven Development.
                        </li>
                    </ul>
                    <ul
                        id="6d266545-1513-46bd-94cc-408f32aa971a"
                        className="bulleted-list"
                    >
                        <li>
                    ...
                    <ul
                        id="a4711076-a662-460b-a103-8b47c9460600"
                        className="bulleted-list"
                    >
                        <li>
                            <strong>CI/CD: </strong>Bamboo, Vercel.
                        </li>
                    </ul>
                    <h3 id="bb230a8e-b284-4cfa-9827-5e68d3b9d93d" className="">
                        OS/Tools
                    </h3>
                    <ul
                        id="06969876-e19f-4a67-99f4-67b97fb5adee"
                        className="bulleted-list"
                    >
                        <li>
                    ...
                    <ul
                        id="29ed8005-c1c1-43de-b0bf-fffc65309d95"
                        className="bulleted-list"
                    >
                        <li>
                    ...
                    <ul
                        id="83536956-f375-4823-a8bf-e1867c149f51"
                        className="bulleted-list"
                    >
                        <li>
                    ...
                    <ul
                        id="5c7ff62b-5897-4201-86f9-825d136d1545"
                        className="bulleted-list"
                    >
                        <li>
                    ...
                    <ul
                        id="930d6eaa-8ea0-41d1-a488-a81f1275a0c6"
                        className="bulleted-list"
                    >
                        <li>
                            <strong>MS Office suite:</strong> MS Workd, MS
                            Outlook, MS Excel, MS Powerpoint.
                        </li>
                    </ul>
                    <ul
                        id="60c97cf2-d837-47ac-b17b-9a079f98355d"
                        className="bulleted-list"
                    >
                        <li>
                    ...
                    <ul
                        id="75414052-a930-4ed4-9bf7-cca2b74d2217"
                        className="bulleted-list"
                    >
                        <li>
                    ...
                    <ul
                        id="06522ca6-cd58-4091-b82f-41e5182fb4b3"
                        className="bulleted-list"
                    >
                        <li>
                    ...
                    <ul
                        id="3ce40a1a-60be-471f-82f0-c8c69c782496"
                        className="bulleted-list"
                    >
                        <li>
                            <strong>Web servers:</strong> Weblogic, Tomcat, inx,
                            Apache
                        </li>
                    </ul>
                    <h3 id="6afdc973-a7bd-494d-a3b0-13f83c2de4e7" className="">
                        Machine Learning, Robotics, Autonomous cars,
                        Computational graphics
                    </h3>
                    <ul
                        id="ef039541-46b6-4723-a34a-bc3f8cf28bb8"
                        className="bulleted-list"
                    >
                        <li>
                    ...
                    <ul
                        id="cf79aaf8-e693-4f1f-9b06-9669750b2311"
                        className="bulleted-list"
                    >
                        <li>
                    ...
                    <ul
                        id="0b818847-dafc-4133-afa9-f60497dc0a1f"
                        className="bulleted-list"
                    >
                        <li>
                            <strong>
                    ...
                    <ul
                        id="31c74a52-116a-44a9-96f8-7f49ed148e82"
                        className="bulleted-list"
                    >
                        <li>
                    ...
                    <ul
                        id="5671b692-0189-49c7-ac0d-f83972482723"
                        className="bulleted-list"
                    >
                        <li>
