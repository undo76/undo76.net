            ...
            <div className="hidden sm:block">
                <div className="border-b border-gray-200">
                    <nav className="-mb-px flex">
                        ...
                        <a
                            href="#"
                            className="whitespace-no-wrap ml-8 py-4 px-1 border-b-2 border-red-500 font-medium text-sm leading-5 text-red-600 focus:outline-none focus:text-indigo-800 focus:border-red-700"
                            aria-current="page"
                        >
                            Team Members
                        </a>
